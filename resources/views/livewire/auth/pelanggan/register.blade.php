                ...
                <form id="register-form"  wire:submit.prevent="register">
                    ...
                    {{-- <x-card title="Alamat Tetap" collapseButton>
                        <x-slot name="body">
                            <div class="row">
                                <div class="col-md-6">
                                    <x-forms.text label="Alamat 1" wire:model="daftarPelanggan.alamat_tetap1" />
                                    <x-forms.text label="Alamat 2" wire:model="daftarPelanggan.alamat_tetap2" />
                                    <x-forms.text label="Alamat 3" wire:model="daftarPelanggan.alamat_tetap3" />
                                </div>
                                <div class="col-md-6">
                                    <x-forms.text label="Poskod" wire:model="daftarPelanggan.poskod" />
